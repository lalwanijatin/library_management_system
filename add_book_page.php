...
Student & Book Details     
		...
		<link rel="stylesheet" href="add_book.css" type="text/css">
		...
		<script>
		     ...
		     function here(){
				...
				/*xhttp.open('GET','add_book.php?title='+document.getElementById('name').value
				+'&edition='+document.getElementById('edition').value
				+'&author='+document.getElementById('author').value
				+'&isbn_code='+document.getElementById('isbn').value
				...
				var shelf_no=document.getElementById('shelf_no').value;
				xhttp.open("POST", "add_book.php", true);          
                xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");       
                var the_data = 'title='+title+'&edition='+edition+'&author='+author+'&isbn_code='+isbn_code+'&shelf_no='+shelf_no;				
                xhttp.send(the_data); 
			} 
		</script>
		...
		<center>
			<!-- <div class="body" id="search"> -->
				 ...
				 <!--  <i class="fa fa-bars fa-4x"></i> -->
			       ...
			       <h1 class="h1" style="font-family:arial;"> Add a Book!</h1>
				   </div>
				    <!-- <form id="form1"> -->
					...
					<input type="number" id="edition" name="edition"  placeholder="Edition" 
	                class="input2" min="1"><br><br>
					
					<input type="text" id="author" name="author"  placeholder="Author" 
	                class="input3"><br><br>
					
					<input type="number" id="isbn" name="isbn"  placeholder="ISBN code" 
	                class="input4" min="1"><br><br>
					
					
					 <input type="number" id="shelf_no" name="shelf_no"  placeholder="Shelf No." 
	                class="input6" min="1"><br><br> 
                    ...
                    <img src="mybutton.jpg" width="50px" height="50px"/>
					 ...
					 <button class="submit1" onclick="here();" value="SUBMIT"><!-- <img src="submit.png"> -->SUBMIT </button>
					...
					<button id="btn"><!-- <img src="reset.jpg" height="50px"> --> RESET</button>
					 ...
					 var field2= document.getElementById('edition');
					 var field3= document.getElementById('author');
					 var field4= document.getElementById('isbn');
					 var field5= document.getElementById('shelf_no');
					...
					<div id="adiv" class="adiv"></div>
	   
	               
					
						
					<!--<script type="text/javascript"  src="js/jquery.js"></script>-->
					<script type="text/javascript"  src="add_book.js"></script>
