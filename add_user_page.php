...
Student & Book Details     
		...
		<link rel="stylesheet" href="add_user.css" type="text/css">
		     ...
		     function here(){
				...
				xhttp.onreadystatechange = function(){
					...
					/*	 var field1= document.getElementById('name');
					 ...
					 var field4= document.getElementById('address');
					 var field5= document.getElementById('number');
					 var field6= document.getElementById('card_number');
					 var field7= document.getElementById('class');
					 var field8= document.getElementById('year');
				...
				xhttp.open('GET','add_user.php?name='+document.getElementById('name').value
				+'&email='+document.getElementById('email').value
				+'&password='+document.getElementById('password').value
				+'&address='+document.getElementById('address').value
				+'&phone_no='+document.getElementById('number').value
				+'&account_no='+document.getElementById('card_number').value
		...
		<center>
			<!-- <div class="body" id="search"> -->
				 ...
				 <!--  <i class="fa fa-bars fa-4x"></i> -->
			       ...
			       <h1 class="h1" style="font-family:arial;"> Add a User!</h1>
				   </div>
				    <!-- <form id="form1"> -->
					...
					<input type="text" id="number" name="number"  placeholder="Phone Number" maxlength="10"
	                class="input6"><br><br>
					
					<input type="text" id="card_number" name="card_number" placeholder="Card number"
					class="input5" maxlength="5"><br><br>
					
					<input type="text" id="class" name="class"  placeholder="Class" 
	                class="input7"><br><br>
					
					<input type="text" id="year" name="year"  placeholder="Year" 
	                class="input8" maxlength="4"><br><br>
